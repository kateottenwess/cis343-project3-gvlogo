...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SEP = 7,                        /* SEP  */
  YYSYMBOL_PENUP = 8,                      /* PENUP  */
  YYSYMBOL_PENDOWN = 9,                    /* PENDOWN  */
  YYSYMBOL_PRINT = 10,                     /* PRINT  */
  YYSYMBOL_CHANGE_COLOR = 11,              /* CHANGE_COLOR  */
  YYSYMBOL_CLEAR = 12,                     /* CLEAR  */
  YYSYMBOL_TURN = 13,                      /* TURN  */
  YYSYMBOL_LOOP = 14,                      /* LOOP  */
  YYSYMBOL_MOVE = 15,                      /* MOVE  */
  YYSYMBOL_NUMBER = 16,                    /* NUMBER  */
  YYSYMBOL_END = 17,                       /* END  */
  YYSYMBOL_SAVE = 18,                      /* SAVE  */
...
{
       0,   100,   100,   102,   103,   105,   106,   111,   112,   113,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "RUN", "SHUTDOWN",
  "GOTO", "WHERE", "SEP", "PENUP", "PENDOWN", "PRINT", "CHANGE_COLOR",
...
#line 105 "gvlogo.y"
                                                                        { prompt(); }
#line 1389 "gvlogo.tab.c"
    break;

  case 6: /* statement: error '\n'  */
#line 106 "gvlogo.y"
                                                                            { yyerror; prompt(); }
#line 1395 "gvlogo.tab.c"
    break;

  case 7: /* command: PENUP  */
#line 111 "gvlogo.y"
                                                                        { penup(); }
#line 1401 "gvlogo.tab.c"
    break;

  case 8: /* command: PENDOWN  */
#line 112 "gvlogo.y"
                                                                                { pendown(); }
#line 1407 "gvlogo.tab.c"
    break;

  case 9: /* command: PRINT STRING  */
#line 113 "gvlogo.y"
                                                                        { output((yyvsp[0].s)); }
#line 1413 "gvlogo.tab.c"
    break;

  case 10: /* command: CLEAR  */
#line 114 "gvlogo.y"
                                                                                { clear(); }
#line 1419 "gvlogo.tab.c"
    break;

  case 11: /* command: GOTO expression expression  */
#line 115 "gvlogo.y"
                                                                { goTo((yyvsp[-1].f), (yyvsp[0].f)); }
#line 1425 "gvlogo.tab.c"
    break;

  case 12: /* command: WHERE  */
#line 116 "gvlogo.y"
                                                                                { where(); }
#line 1431 "gvlogo.tab.c"
    break;

  case 13: /* command: CHANGE_COLOR expression expression expression  */
#line 117 "gvlogo.y"
                                                                                { change_color((yyvsp[-2].f), (yyvsp[-1].f), (yyvsp[0].f)); }
#line 1437 "gvlogo.tab.c"
    break;

  case 14: /* command: TURN expression  */
#line 118 "gvlogo.y"
                                                                                        { turn((yyvsp[0].f)); }
#line 1443 "gvlogo.tab.c"
    break;

  case 15: /* command: MOVE expression  */
#line 119 "gvlogo.y"
                                                                                        { move((yyvsp[0].f)); }
#line 1449 "gvlogo.tab.c"
    break;

  case 16: /* command: SAVE STRING  */
#line 120 "gvlogo.y"
                                                                                                { save((yyvsp[0].s)); }
#line 1455 "gvlogo.tab.c"
    break;

  case 17: /* command: SHUTDOWN  */
#line 121 "gvlogo.y"
                                                                                    { shutdown(); }
#line 1461 "gvlogo.tab.c"
    break;

  case 18: /* command: CHAR EQUAL expression_list  */
#line 122 "gvlogo.y"
                                                                                { store_variables((yyvsp[-2].c), (yyvsp[0].f)); }
#line 1467 "gvlogo.tab.c"
    break;

  case 22: /* expression: NUMBER PLUS expression  */
#line 128 "gvlogo.y"
                                                                        { (yyval.f) = (yyvsp[-2].f) + (yyvsp[0].f); }
#line 1473 "gvlogo.tab.c"
    break;

  case 23: /* expression: NUMBER MULT expression  */
#line 129 "gvlogo.y"
                                                                                { (yyval.f) = (yyvsp[-2].f) * (yyvsp[0].f); }
#line 1479 "gvlogo.tab.c"
    break;

  case 24: /* expression: NUMBER SUB expression  */
#line 130 "gvlogo.y"
                                                                                { (yyval.f) = (yyvsp[-2].f) - (yyvsp[0].f); }
#line 1485 "gvlogo.tab.c"
    break;

  case 25: /* expression: NUMBER DIV expression  */
#line 131 "gvlogo.y"
                                                                                { (yyval.f) = (yyvsp[-2].f) / (yyvsp[0].f); }
